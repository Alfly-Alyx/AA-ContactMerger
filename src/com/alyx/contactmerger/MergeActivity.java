...
import com.alyx.contactmerger.ui.MergeListAdapter;
...
public class MergeActivity extends Activity implements View.OnClickListener {
    ...
    protected View analysisStatus;
    protected View welcomeBrand;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (event) {
                ...
                case "progress":
                    ...
                    showAnalysisMessage();
                    loadText.setText(getString(R.string.analysis_progress, (int) (f * 100)));
                    return;
                case "finish":
    ...
    public void updateList() {
        ...
        welcomeBrand = findViewById(R.id.welcome_brand);
        ...
        if (path.exists() && modelFile.exists()) {
            startScan.setVisibility(View.VISIBLE);
            analysisStatus.setVisibility(View.GONE);
            welcomeBrand.setVisibility(View.GONE);
    ...
    protected void onStart() {
        ...
        LocalBroadcastManager.getInstance(getApplicationContext())
                .registerReceiver(receiver, new IntentFilter("com.alyx.contactmerger.ANALYSE"));
    ...
    private void showContactsPermissionRequired() {
        ...
        startScan = retry;
        View brand = findViewById(R.id.welcome_brand);
        View status = findViewById(R.id.analysis_status);
        View progress = findViewById(R.id.progress_bar_container);
        brand.setVisibility(View.GONE);
        status.setVisibility(View.VISIBLE);
        progress.setVisibility(View.GONE);
        message.setVisibility(View.VISIBLE);
        message.setText(R.string.contact_permission_required);
        retry.setVisibility(View.VISIBLE);
        retry.setOnClickListener(this);
    }

    private void showWelcomeBrand() {
        if (welcomeBrand != null) {
            welcomeBrand.setVisibility(View.VISIBLE);
        }
    ...
    private void showAnalysisMessage() {
        ViewSwitcher switcher = findViewById(R.id.switcher);
        if (switcher != null) {
            switcher.setDisplayedChild(0);
        }
